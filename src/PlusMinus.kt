...
fun plusMinus(arr: Array<Int>) {
    ...
    val totalSize = arr.size.toDouble()
    val positiveRatio = positive.toDouble() / totalSize
    val negativeRatio = negative.toDouble() / totalSize
    val zeroRatio = zero.toDouble() / totalSize
